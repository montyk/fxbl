 ...
 *
 * $Date: 2008-04-15 +0100 (Tue, 15 Apr 2008) $
 * $version: 1.1.1
 */
jQuery(function($) {
	...
	$.fn.nyroModal.settings = {
		...
		closeButton: '<div id="cls"><a href="#" class="nyroModalClose" id="closeBut" title="close">Close</a></div>', // Adding automaticly as the first child of #nyroModalWrapper 
	...
	function wrapContent() {
		...
		var wrapper = modal.contentWrapper.children(':first');
		
		var outerWrapper = getOuter(modal.contentWrapper);
		var outerWrapper2 = getOuter(wrapper);
		...
		wrapper.css(jQuery.extend({}, tmp.wrapper2, currentSettings.css.wrapper2));
