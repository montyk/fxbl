...
addSubGrid : function( pos, sind ) {
	return this.each(function(){
		...
		var subGridXml = function(sjxml, sbid){
			var tddiv, i,  sgmap,
			dummy = $("<table cellspacing='0' cellpadding='0' border='0' width='"+ts.p.subGridOptions.width+"'><tbody></tbody></table>"),
			trdiv = $("<tr></tr>");
			if( ts.p.subGridOptions.showHeader){
				...
				for (i = 0; i<ts.p.subGridModel[0].name.length; i++) {
					tddiv = $("<th class='ui-state-default ui-th-subgrid ui-th-column jqgfirstrow' style='width:"+ts.p.subGridModel[0].width[i]+"px;height:auto;'></th>");					
					$(trdiv).append(tddiv);
				}
			}
			$(dummy).append(trdiv);
