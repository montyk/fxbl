...
<!--        <meta content="text/html; charset=UTF-8" http-equiv="content-type">-->
        ...
        <link href="<?php echo base_url(); ?>misc/css/css3-buttons.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo base_url(); ?>misc/css/alert.css" rel="stylesheet" type="text/css" />
