        ...
        <div class="ftr_copy pos_rel">
            <div class="ftr_copy_ca tahoma f12 c_94 tac pg_width">
                ...
                <div class="follow pos_ab">
                    <div>FOLLOW US</div>
                    <div class="mt6">
                        <img src="<?php echo base_url(); ?>misc/css/images/facebook.png" alt="facebook" width="24" height="24" />
                        <img src="<?php echo base_url(); ?>misc/css/images/twitter.png" alt="twitter" width="24" height="24" />
                        <img src="<?php echo base_url(); ?>misc/css/images/blog.png" alt="blog" width="24" height="24" />
                    </div>
                </div>
            </div>	
            <div class="cl"></div>
