       ...
       <script>
        ...
        $(document).ready(function(){
            ...
            jQuery("#sub_grid_tbl").jqGrid431({
                url:'<?php echo site_url(); ?>adminusers/get_removeinvestors/',
                datatype: "json",
                mtype:'POST',
                height: $('#sidebar').height()-24,
                width: $('.form_prp').width()-10,
                colNames:['ID','Account','Name', 'Minimum Deposit (USD)','Deposited Amount(%)','Trading Period','Remove Investors'],
                colModel:[
                    {name:'id',index:'id'},
                    ...
                    {name:'remove_investors',index:'remove_investors'}
                ],
                rowNum:6,
                //rowList:[10,20,30],
