    ...
    <div class="right_content">
        ...
        <section id="main" class="column section">
            <div class="form_prp">
                ...
                <form name="registerform" id="registration_form" action="<?php echo site_url('adminusers/update_investors'); ?>" method="post" enctype="multipart/form-data" >
                    ...
                    <div class="h_2">Investor Details:</div>
                   
                
                    <div class="d_fds">
                        <div class="left_fld">
                            <label for="amount"> <span class="validcol">*</span> Required money add to his/her Wallet:</label>
                        </div>
                        <div class="right_fld">
