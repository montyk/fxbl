...
<body class="app">
    ...
    <?php
    //include BASEPATH.'application/views/common/header'; 
//echo $header;
    ?>
...
<?php $this->load->view('admingallery/view_gallery'); ?>
                ...
                <form name="add_page" id="add_page" action="" method="post" >
                    ...
                    <div class="d_fds">
                        ...
                        <div class="right_fld">
                            <input name="files" id="myfile1" class="myfile1" value="" type="hidden" title="Please upload a Image"/>
