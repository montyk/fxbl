                            ...
                            <tbody><tr>
                                    <td class="w580" width="580">
                                        ...
                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                            <p>Hello <?php if(!empty($name)){ echo $name; }else{ echo 'Customer'; } ?>,</p>
                                            <p><span>This email was sent automatically by <span class="cm-singleline" label="Title"><span style="color:#5599d6;">Forex</span><span style="color:#f0893a;">Ray</span></span> in response to your request to reset your password.</span></p>
											
											<p>Please, <a href="<?php echo site_url('forgotpassword/resetpassword/'.base64_encode($login)); ?>" target="_blank"><b style="color:#FCA810;">Click here</b></a> to reset your password.</p>
                                        </div>
                                    </td>
                                </tr>
