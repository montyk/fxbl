                            ...
                            <tbody><tr>
                                    <td class="w580" width="580">
                                        ...
                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                            ...
                                            <p><span>Your request for an </span><span class="cm-singleline" label="Title"><span style="color:#5599d6;">Forex</span><span style="color:#f0893a;">Ray</span></span> <?php if(!empty($registration_type) && $registration_type=='real'){ echo 'Real'; }else{ echo 'Demo'; } ?> Trading account has been successful, and we are pleased to provide you with the account details below</p>
                                        </div>
                                    </td>
                                </tr>
                                                                        ...
                                                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                                                            <p>
                                                                                ...
                                                                                <br/>
                                                                                    Server:
                                                                                    <br/>
                                                                                <?php if (!empty($registration_type) && $registration_type == 'real') { ?>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="w180" width="180">
                                                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                                                            <p>
                                                                                <?php if (!empty($login_id)) echo $login_id; ?>
                                                                                <br/>
                                                                                <?php if (!empty($password)) echo $password; ?>
                                                                                <br/>
                                                                                <?php if (!empty($registration_type) && $registration_type == 'demo') {echo DEMO_T_MT4_HOST;  }  
																				else if (!empty($registration_type) && $registration_type == 'real')
																				{echo T_MT4_HOST;?>
																				<br/>
                                                                                <?php if(!empty($phone_password)) echo $phone_password;?>
                                                                                <br/>
																				<?php }?>
                                                                            </p>
                                                                        </div>
                                ...
                                <tr>
                                    <td class="w580" width="580">
                                        <p>
                                            Please keep these details safe and secure.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
