                            ...
                            <tbody><tr>
                                    <td class="w580" width="580">
                                        ...
                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                            ...
                                            <p><span>You have just successfully reset your </span><span class="cm-singleline" label="Title"><span style="color:#5599d6;">Forex</span><span style="color:#f0893a;">Ray</span></span> Login Password</p>
                                        </div>
                                    </td>
                                </tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td class="w180" width="180">
                                                                        <div align="left" class="article-content" style="font-size: 13px; line-height: 18px; color: #444444; margin-top: 0px; margin-bottom: 18px; font-family: 'Helvetica Neue', Arial, Helvetica, Geneva, sans-serif;">
                                                                            <p>
                                                                                <?php echo $this->config->item('project_name') ?> Login:
                                                                                <br/>
                                                                                Password:
                                                                                <br/>
