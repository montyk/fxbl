                    ...
                    <td width="595" style="padding:.75pt .75pt .75pt .75pt">
                        <table width="550" border="0" cellpadding="0" style="margin-left:15.0pt">
                            <tbody>
                                ...
                                <tr>
                                    <td width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                        <span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a; text-align:right">Wire Transfer Charges :</span>								  
                                    </td>
                                    <td width="138"  height="20" style="padding:.75pt .75pt .75pt .75pt; height:20px; ">
                                        <b><span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a"><?php echo $payment_method_fee2; ?> </span></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                ...
                                <tr>
                                    <td width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                        <span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a; text-align:right"><b>Account Name:</b></span>								  
                                    </td>
                                    <td width="138"  height="20" style="padding:.75pt .75pt .75pt .75pt; height:20px; ">
                                        <b><span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a"><?php echo $value->name; ?> </span></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                        <span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a; text-align:right"><b>Account Number:</b></span>								  
                                    </td>
                                    <td width="138"  height="20" style="padding:.75pt .75pt .75pt .75pt; height:20px; ">
                                        <b><span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a"><?php echo $value->account_number; ?> </span></b>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2" width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                        <p style="line-height:20px">Upon payment verification we will transfer money to your bank account:</p>								  
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td width="138"  height="20" style="padding:.75pt .75pt .75pt .75pt; height:20px; ">
                                        <b><span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a"><?php echo $beneficiary_name; ?> </span></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                    ...
                                    <td width="138"  height="20" style="padding:.75pt .75pt .75pt .75pt; height:20px; ">
                                        <b><span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a"><?php echo $beneficiary_addr; ?> </span></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                    ...
                                    <td width="138"  height="20" style="padding:.75pt .75pt .75pt .75pt; height:20px; ">
                                        <b><span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a"><?php echo $sell_lr_account; ?> </span></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                    ...
                                    <td width="138"  height="20" style="padding:.75pt .75pt .75pt .75pt; height:20px; ">
                                        <b><span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a"><?php echo $bank_name_addr; ?> </span></b>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                    ...
                                    <td width="138"  height="20" style="padding:.75pt .75pt .75pt .75pt; height:20px; ">
                                        <b><span style="font-size:9.0pt;font-family:Arial, Helvetica, sans-serif;color:#5a5a5a"><?php echo $bank_swift; ?> </span></b>
                                    </td>
                                </tr>
                                    ...
                                    <td colspan="2" width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                        <p style="line-height:20px">
                                            ...
                                            <div style="line-height:22px;margin-bottom:10px">
                                                <div>1) login to our website and click the "Sell", In Sell tab click sell orders.</div>
                                ...
                                <tr>
                                    <td colspan="2" width="80" style="padding:.75pt .75pt .75pt .75pt; height:30px; ">
                                        <p style="line-height:20px">
                                            <b>**</b> Beware of Phishing attacks, Please ensure the account number mentioned above is correct with our customer care live chat before transferring your amount.
                                        </p>
                                        <p style="line-height:20px">
                                            <b>**</b> For more security, You can also transfer 0.01 amount to the above account number and check with our live customer care chat regarding the successful reception of your amount.
                                        </p>
                                    </td>
                                </tr>
                            </tbody>
