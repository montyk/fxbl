...
<?php $this->load->view('common/header', $data);?>
  ...
  <?php /*  <script type="text/javascript" src="<?php echo base_url(); ?>public/js/ckeditor/ckeditor.js"></script>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            jQuery("#sub_grid_tbl").jqGrid431({
                ...
                scrollOffset:0,
                colNames:['Yield','Account','Balance','Name', 'Minimum Deposit <br /> (USD)','Success Fee (%)', 'Penaulty Fee (%)','Trading <br />Period'],
                colModel:[
                    {name:'id',index:'id', resizable:false },
                    {name:'login',index:'login', resizable:false},
                    {name:'balance',index:'balance', resizable:false},
                    {name:'trading_name',index:'trading_name',  resizable:false},
                    {name:'minimum_deposit',index:'minimum_deposit',  resizable:false},
                    {name:'success_fee',index:'success_fee',  resizable:false},
                    {name:'penalty_fee',index:'penalty_fee',  resizable:false},
                    {name:'trading_period',index:'trading_period', resizable:false}
                ],
                rowNum:25,
                //rowList:[10,20,30],
                ...
                childGrid: true,
                childGridIndex: "rows",
                loadtext:'<img alt="Loading..." height="36" width="36" src="<?php echo base_url(); ?>public/images/36.gif"/>'
            });
        ...
        <section id="main" class="column section">
            ...
            <div class="panel flt_panel">
                <div class="d_fds">
					...
					<a class="nblu_btn fl japply_filter">
