...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title><?php echo $this->config->item('project_name') ?> - My Profile</title>
    ...
    <body class="app pamm_man_update">
        ...
        <div id="wrap">
            ...
            <div class="contentarea p_r">
                ...
                <div class="rightNav">	
                    <div class="rightNav_head">My Test Profile</div>
                    <div class="rightNav_cnt">
                        ...
                        <div class="o_h sum_box r_f m_t_20">
                            <form method="post" action="<?php echo site_url('userpages/update_profile'); ?>" class="j_general_validate">
                                ...
                                <div class="m_t_10 clearfix">
                                    <div class="lft_stflbl"><label for="trading_name"><span class="star">*</span>ISD Code:</label></div>
                                    <div class="rgt_stflbl">
                                        <select id="isd_code" name="isd_code" placeholder="Country ISD Code" class="ip r_f required">
                                            <?php if(!empty($isd_code)){ $isd_code= $isd_code; }else{ $isd_code=0;  } ?>
								...
								<div class="m_t_10 clearfix">
                                    <div class="lft_stflbl"><label for="trading_name">OTP After Login:</label></div>
                                    <div class="rgt_stflbl">
										<input type="radio" name="otp" value="0" <?php if(empty($otp) || (isset($otp) && $otp=='0')){ ?>checked="" <?php } ?> />No
										<input type="radio" name="otp" value="1" <?php if(isset($otp) && $otp=='1'){ ?>checked="" <?php } ?> />Yes
									</div>
                                </div>								
