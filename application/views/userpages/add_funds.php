                ...
                <div class="rightNav">	
                    ...
                    <div class="rightNav_cnt">
                        ...
                        <div class="o_h sum_box r_f m_t_20">
                            <form method="post" action="<?php echo site_url('userpages/save_addfunds'); ?>" class="j_general_validate">
							
                                <input type="hidden" name="id" value="<?php echo (isset($id) && $id!='')?$id:0; ?>" id="id"/>
                                <input type="hidden" name="program_id" value="<?php echo (isset($program_id) && $program_id!='')?$program_id:0; ?>" id="program_id"/>
                                <input type="hidden" class="hide" name="page" value="add_funds" />
