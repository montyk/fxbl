    ...
    <body class="app pamm_man_update">
        ...
        <div id="wrap">
            ...
            <div class="contentarea p_r">
                ...
                <div class="rightNav">	
                    <div class="rightNav_head">Internal Transfer</div>
                    <div class="rightNav_cnt">
                       
                        <?php $this->load->view('common/userpages/notifications'); ?>
                        
                        <div class="hdr1 f_b m_b_10">Internal Transfer</div>
						<?php if(isset($message) && $message!=''){
						if($msg=='3' || $msg=='5' ) $class='alert_success'; else $class='alert_error';
						?>
                        ...
                        <div class="o_h sum_box r_f m_t_20">
                            <form method="post" action="<?php echo site_url('userpages/save_it'); ?>" class="j_general_validate">
							
                                <input type="hidden" name="id" value="<?php echo (isset($id) && $id!='')?$id:0; ?>" id="id"/>
                                <input type="hidden" class="hide" name="page" value="internal_transfer" />
                                <div class="log_bankdet col_blk ">
                                    Please enter the details below:
                                </div>
								
                                <div class="m_t_10 clearfix">
                                    <div class="lft_stflbl"><label for="trading_name"><span class="star">*</span>Account No:</label></div>
                                    <div class="rgt_stflbl"><input type="text" name="acount_no" id="acount_no"  class="ip r_f required" placeholder="Account Number" title="Please enter the Account Number" /></div>
                                </div>
