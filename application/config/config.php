...
$config['document_root_text'] = '/var/www/';
...
$config['sidebar_news_count']       =3;
$config['sidebar_promotions_count'] =3;


/*OTP API Keys*/
//$config['api_key'] = 'info@forexray.com';
//$config['api_secret'] = 'cri015Qttn3wr7oImdgl';
/*End of OTP API*/
