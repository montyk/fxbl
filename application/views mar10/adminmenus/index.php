...
//               console.log('<<<<<<<<<<<<');
        ...
        $('.add_menu').live('click',function(){
            ...
            $('#order_num, #footer_order_num').val($(this).parent('li').find('ul:first>li').length+1);
        ...
        function loadMenuList(){
            ...
            $.ajax({
                ...
                success:function(dataR){
                    ...
                    $('#order_num, #footer_order_num').val($('.menus_list ul:first>li').length+1);
...
*/    .add_menu{
	...
	.menus_list .menu_hdr{
		...
		background-image: -webkit-gradient(linear, 0 0%, 0 100%, from(#fdfdfd), to(#e0e2e9));
		background-image: -webkit-linear-gradient(top, #fdfdfd 0%, #e0e2e9 100%);
		background-image: -moz-linear-gradient(top, #fdfdfd 0%, #e0e2e9 100%);
		background-image: -ms-linear-gradient(top, #fdfdfd 0%, #e0e2e9 100%);
		background-image: -o-linear-gradient(top, #fdfdfd 0%, #e0e2e9 100%);
		background-image: -linear-gradient(top, #fdfdfd 0%, #e0e2e9 100%);
		filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#fdfdfd', endColorstr='#e0e2e9',GradientType=0 ); /* IE6-9 */
	...
	.menus_list .menu_hdr a{
		color: #004a87;	
	}
	.menus_list .menu_content{
		padding: 16px;
	}
	.menus_list .menu_content img{
		margin-right: 3px;
	}
	.menus_list .edit_menu,
	.menus_list .remove_menu{
		float: right;
		margin-left: 10px;
	}
	.menus_list .add_menu{
