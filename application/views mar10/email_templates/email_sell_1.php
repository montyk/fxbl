                                ...
                                <table border="0" cellpadding="0" cellspacing="0" style="padding:10px; font-size:13px; color:#565656">
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td style="padding:10px 10px 5px 0">Wire Transfer Charges</td>
                                                    <td style="color:#010101;padding:10px 0 5px 0"><?php echo $payment_method_fee2; ?></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td width="200" style="padding:10px 10px 5px 0">Beneficiary's name:</td>	
                                                    <td width="400" style="color:#010101;padding:10px 0 5px 0"> <?php echo $beneficiary_name;  ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:10px 10px 5px 0">Beneficiary's address: </td>
                                                    <td style="color:#010101;padding:10px 0 5px 0"> <?php echo $beneficiary_addr;  ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:10px 10px 5px 0">Bank Account No. or IBAN:</td>
                                                    <td style="color:#010101;padding:10px 0 5px 0"> <?php echo $sell_lr_account;  ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:10px 10px 5px 0">Bank name and address:</td>
                                                    <td style="color:#010101;padding:10px 0 5px 0"> <?php echo $bank_name_addr;  ?></td>
                                                </tr>
                                                <tr>
                                                    <td style="padding:10px 10px 5px 0">Bank SWIFT or ABA:</td>
                                                    <td style="color:#010101;padding:10px 0 5px 0"> <?php echo $bank_swift;  ?></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <div style="line-height:22px;margin-bottom:10px">
                                                <div>1) login our website and click the "Sell", In Sell tab click sell orders.</div>
