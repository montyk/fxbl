...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs">					 <img src="<?php echo base_url();  ?>misc/css/images/fav.png" class="fl bread_logo" /> <div class="breadcrumb_divider"></div> <a class="current">Add New User</a></article>
		</div>
	...
	<section id="main" class="column">
        ...
        <div class="form_prp">
            ...
            <form name="registerform" id="registerform" action="<?php echo site_url('users/adduser');?>" method="post" >
