...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.j_cancel').click(function(){
            window.location='<?php echo site_url('adminfootermenus'); ?>';
        })
                            ...
                            <div class="d_fds" style="display:none;">
                                ...
                                <div class="right_fld" style="position:relative;">
                                    <select id="parent_id" class="sl_bx " name="parent_id" title="">
                                        <?php echo selectBox('Select parent if required', 'footer_menus', 'id,name', ' status=1 ', ((!empty($parent_id))?$parent_id:0), ''); ?>
                                    </select>
                                </div>
                                <div class="cb"></div>
                            </div>
