...
class JQ_UploadHandler
{
    protected $options;
    // PHP File Upload error message codes:
    // http://php.net/manual/en/features.file-upload.errors.php
    protected $error_messages = array(
        1 => 'The uploaded file exceeds the limit',
        2 => 'The uploaded file exceeds the limit',
        3 => 'The uploaded file was only partially uploaded',
        4 => 'No file was uploaded',
        6 => 'Missing a temporary folder',
        7 => 'Failed to write file to disk',
        8 => 'A PHP extension stopped the file upload',
        'post_max_size' => 'The uploaded file exceeds the system upload limit',
    ...
    protected function initialize() {
        switch ($this->get_server_var('REQUEST_METHOD')) {
            ...
            case 'POST':
                ...
                break;
            case 'DELETE':
                // $this->delete(); // Removed Manually MMJ, Avoid any simple hack attempt
                break;
            default:
